...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    begin
      params  = [{"tracking_number" => "ESIG50011000092433","courier_code"=>"intelcom"},{"tracking_number" => "INTLCMF654738931","courier_code"=>"intelcom"}]
...
Get status of the shipment:
    ...
    begin
      ...
      # params  = {"tracking_numbers" => "ESIG50011000092433,INTLCMF654738931","courier_code"=>"intelcom"}
